...
const UseMapExample = () => {
  ...
  if (map) {
    const center = new mapkit.Coordinate(40.686581, -73.963711);
    ...
    const routeLine = new mapkit.PolylineOverlay(routeCoordinates, {
      style: routeStyle,
    });

    map.addOverlay(routeLine);

    const start = new mapkit.MarkerAnnotation(
        new mapkit.Coordinate(40.719818880450106, -73.95346462726593),
        { title: "Start" }
      ),
      finish = new mapkit.MarkerAnnotation(
        new mapkit.Coordinate(40.66015590607582, -73.97063612937926),
        { title: "Finish" }
      );
